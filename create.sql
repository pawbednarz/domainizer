...
ALTER TABLE "domain_scan_config"
    ADD FOREIGN KEY ("dictionary_config") REFERENCES "dictionary_config" ("id_dictionary_config");

ALTER TABLE "scan"
    ADD FOREIGN KEY ("domain_scan_config_id") REFERENCES "domain_scan_config" ("id_domain_scan_config");

ALTER TABLE "scan"
    ADD FOREIGN KEY ("vuln_scan_config_id") REFERENCES "vuln_scan_config" ("id_vuln_scan_config");

ALTER TABLE "domain"
    ADD FOREIGN KEY ("run_scan_id") REFERENCES "run_scan" ("id_run_scan");

ALTER TABLE "run_scan"
    ADD FOREIGN KEY ("scan_id") REFERENCES "scan" ("id_scan");

ALTER TABLE "open_port"
    ADD FOREIGN KEY ("run_vuln_scan_id") REFERENCES "run_vuln_scan" ("id_run_vuln_scan");

ALTER TABLE "security_issue"
    ADD FOREIGN KEY ("open_port_id") REFERENCES "open_port" ("id_open_port");

ALTER TABLE "run_vuln_scan"
    ADD FOREIGN KEY ("run_scan_id") REFERENCES "run_scan" ("id_run_scan");

INSERT INTO user_data
VALUES (1, 'admin',
        '7a3f9a3f6c11e35c7a443a825112a1d0:9cff5ed4aa32ee25759805c9760539897ade7525765a934f1051c12527f480a3ec3dc58b54810b79a9d14a1e9fa16e9fa48f656fad276807656f2ad9b98e6dbd',
        'admin@localhost', 0);